...
% };
titles = {
    'Post-Double Mean Bias', 'Discrete Mean Bias',  'Post-Double rp(0.05)', 'Discrete rp(0.05)',  ...
    'Post-Double Relevant', 'Discrete Relevant',  'Post-Double Total', 'Discrete Total', 'Half-Discrete Total', 'Adaptive Total', 'Score Total'
...
for col = 1:4
    ...
    switch col
        case 1
            matrices = {matrix_1, matrix_2}; % Column 1: matrix_1, matrix_4, matrix_7
        case 2
            matrices = {matrix_6, matrix_7}; % Column 2: matrix_2, matrix_5, matrix_8
        case 3
            matrices = {matrix_11, matrix_12}; % Column 3: matrix_3, matrix_6, matrix_9
        case 4
            matrices = {matrix_16, matrix_17}; % Column 4 (mirroring column 3): matrix_7, matrix_8, matrix_9
    end
    ...
    for row = 1:2
        ...
        title_text = titles{(col-1)*2 + row}; % Get title from titles array
